...
func (c *sayHelloClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReponse, error) {
...
func (UnimplementedSayHelloServer) SayHello(context.Context, *HelloRequest) (*HelloReponse, error) {
